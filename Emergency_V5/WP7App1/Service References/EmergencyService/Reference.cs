...
namespace WP7App1.EmergencyService {
    ...
    public interface IMyPushService {
        ...
        System.IAsyncResult BeginGetNotificationHistory(string username, string deviceId, System.AsyncCallback callback, object asyncState);
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IMyPushService/ClientLogOut", ReplyAction="http://tempuri.org/IMyPushService/ClientLogOutResponse")]
        System.IAsyncResult BeginClientLogOut(string deviceId, System.AsyncCallback callback, object asyncState);
        
        void EndClientLogOut(System.IAsyncResult result);
    }
    ...
    public partial class MyPushServiceClient : System.ServiceModel.ClientBase<WP7App1.EmergencyService.IMyPushService>, WP7App1.EmergencyService.IMyPushService {
        ...
        private BeginOperationDelegate onBeginClientLogOutDelegate;
        
        private EndOperationDelegate onEndClientLogOutDelegate;
        
        private System.Threading.SendOrPostCallback onClientLogOutCompletedDelegate;
        ...
        public event System.EventHandler<System.ComponentModel.AsyncCompletedEventArgs> ClientLogOutCompleted;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WP7App1.EmergencyService.IMyPushService.BeginGetNotificationHistory(string username, string deviceId, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetNotificationHistory(username, deviceId, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginGetNotificationHistory(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((WP7App1.EmergencyService.IMyPushService)(this)).BeginGetNotificationHistory(username, deviceId, callback, asyncState);
        }
        ...
        public void GetNotificationHistoryAsync(string username, string deviceId) {
            this.GetNotificationHistoryAsync(username, deviceId, null);
        }
        
        public void GetNotificationHistoryAsync(string username, string deviceId, object userState) {
            ...
            base.InvokeAsync(this.onBeginGetNotificationHistoryDelegate, new object[] {
                        username,
                        deviceId}, this.onEndGetNotificationHistoryDelegate, this.onGetNotificationHistoryCompletedDelegate, userState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WP7App1.EmergencyService.IMyPushService.BeginClientLogOut(string deviceId, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginClientLogOut(deviceId, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void WP7App1.EmergencyService.IMyPushService.EndClientLogOut(System.IAsyncResult result) {
            base.Channel.EndClientLogOut(result);
        }
        
        private System.IAsyncResult OnBeginClientLogOut(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string deviceId = ((string)(inValues[0]));
            return ((WP7App1.EmergencyService.IMyPushService)(this)).BeginClientLogOut(deviceId, callback, asyncState);
        }
        
        private object[] OnEndClientLogOut(System.IAsyncResult result) {
            ((WP7App1.EmergencyService.IMyPushService)(this)).EndClientLogOut(result);
            return null;
        }
        
        private void OnClientLogOutCompleted(object state) {
            if ((this.ClientLogOutCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.ClientLogOutCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void ClientLogOutAsync(string deviceId) {
            this.ClientLogOutAsync(deviceId, null);
        }
        
        public void ClientLogOutAsync(string deviceId, object userState) {
            if ((this.onBeginClientLogOutDelegate == null)) {
                this.onBeginClientLogOutDelegate = new BeginOperationDelegate(this.OnBeginClientLogOut);
            }
            if ((this.onEndClientLogOutDelegate == null)) {
                this.onEndClientLogOutDelegate = new EndOperationDelegate(this.OnEndClientLogOut);
            }
            if ((this.onClientLogOutCompletedDelegate == null)) {
                this.onClientLogOutCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnClientLogOutCompleted);
            }
            base.InvokeAsync(this.onBeginClientLogOutDelegate, new object[] {
                        deviceId}, this.onEndClientLogOutDelegate, this.onClientLogOutCompletedDelegate, userState);
        }
        ...
        private class MyPushServiceClientChannel : ChannelBase<WP7App1.EmergencyService.IMyPushService>, WP7App1.EmergencyService.IMyPushService {
            ...
            public System.IAsyncResult BeginGetNotificationHistory(string username, string deviceId, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[2];
                _args[0] = username;
                _args[1] = deviceId;
            ...
            public System.IAsyncResult BeginClientLogOut(string deviceId, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = deviceId;
                System.IAsyncResult _result = base.BeginInvoke("ClientLogOut", _args, callback, asyncState);
                return _result;
            }
            
            public void EndClientLogOut(System.IAsyncResult result) {
                object[] _args = new object[0];
                base.EndInvoke("ClientLogOut", _args, result);
            }
        }
    }
}
